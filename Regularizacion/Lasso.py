...
# Ajustar el modelo Lasso con validación cruzada k=10
...
graph_path = './Regularizacion/lasso_coefficients.png'  # Ruta donde se guardará la gráfica
plt.figure(figsize=(10, 6))
plt.bar(X.columns, np.abs(coefficients), color="skyblue")
